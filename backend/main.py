...
from summary_generator import get_summary  # Make sure to create this import correctly
    ...
    try:
        ...
        if transcription_active and websocket.application_state == WebSocketState.CONNECTED:
            try:
                ...
                summary = get_summary(full_transcript.strip())
                
                # Send summary to the frontend
                ...
                print(f"Error sending final transcript or summary: {str(e)}")
